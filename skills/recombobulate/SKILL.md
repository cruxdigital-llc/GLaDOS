---
description: Systematically clean up vibe debt and formalize implicit patterns
---

Read and follow the workflow at `${CLAUDE_PLUGIN_ROOT}/src/workflows/recombobulate.md`.
