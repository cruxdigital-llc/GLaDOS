...
1. Create the `product-knowledge/` directory structure:
   - `product-knowledge/PROJECT_STATUS.md` — copy from `${CLAUDE_PLUGIN_ROOT}/templates/PROJECT_STATUS.md`
   - `product-knowledge/personas/` — copy all files from `${CLAUDE_PLUGIN_ROOT}/personas/`
   ...
   - `product-knowledge/observations/` — create directory with:
     - `observed-standards.md` — copy from `${CLAUDE_PLUGIN_ROOT}/templates/OBSERVED_STANDARDS.md`
     - `observed-philosophies.md` — copy from `${CLAUDE_PLUGIN_ROOT}/templates/OBSERVED_PHILOSOPHIES.md`
